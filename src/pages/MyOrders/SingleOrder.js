...
const SingleOrder = (props) => {
  ...
  const statusBackground = () => {
    if (props.btnText === "Ready To Dispatch") {
      return "#3A44A1";
  ...
  return (
    <div className="single-order mt-4">
      <div className="single-order-heading d-flex justify-content-between ">
        <div>
          <h6>Order Number</h6>
      ...
      {screen > 1000 && <hr style={{ borderColor: "#424242" }} />}

      <div
        className="d-flex justify-content-between align-items-center ordered-items"
        ...
        <div className="order-items d-flex justify-content-between">
          ...
          {props.product
            ? props.product.map((item) => {
                return (
                  <div className="items-name-and-qty">
...
export default withRouter(
  connect(mapStatetoProps, { changeOrderStatus })(SingleOrder)
);
