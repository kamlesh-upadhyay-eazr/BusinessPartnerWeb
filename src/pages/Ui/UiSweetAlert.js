                    ...
                    <Row className="text-center">
                      ...
                      <Col xl={3} lg={4} sm={6} className="mb-2">
                        <div className="p-3">
                          ...
                          <Button
                            onClick={() =>
                              this.setState({ alert_confirm: true })
                            }
                            type="button"
                            color="primary"
                            className=" waves-effect waves-light"
                      ...
                      <Col xl={3} lg={4} sm={6} className="mb-2">
                        ...
                        {this.state.img_header ? (
                          <SweetAlert
                            ...
                            customIcon={logodark}
                            onConfirm={() =>
                              this.setState({ img_header: false })
                            }
                          >
                      ...
                      <Col xl={3} lg={4} sm={6} className="mb-2">
                        ...
                        {this.state.sweet_timer ? (
                          <SweetAlert
                            ...
                            showConfirm={false}
                            onConfirm={() =>
                              this.setState({ sweet_timer: false })
                            }
                          >
                      ...
                      <Col xl={3} lg={4} sm={6} className="mb-2">
                        ...
                        {this.state.custom_div ? (
                          <SweetAlert
                            ...
                            onConfirm={() =>
                              this.setState({ custom_div: false })
                            }
                          ></SweetAlert>
                        ) : null}
                      </Col>
                      ...
                      <Col xl={3} lg={4} sm={6} className="mb-2">
                        ...
                        {this.state.final_step ? (
                          <SweetAlert
                            ...
                            onConfirm={() =>
                              this.setState({ final_step: false })
                            }
                          >
                      ...
                      <Col xl={3} lg={4} sm={6} className="mb-2">
                        ...
                        {this.state.final_queue ? (
                          <SweetAlert
                            ...
                            title=""
                            onConfirm={() =>
                              this.setState({ final_queue: false })
                            }
                          >
