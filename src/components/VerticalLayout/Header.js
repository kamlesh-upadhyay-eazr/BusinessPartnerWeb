...
class Header extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <header id="page-topbar" style={{ background: "#1D1D1F" }}>
            ...
            <div className="d-flex">
              ...
              >
                ...
                <Link to="/" className="logo logo-light">
                  <span className="logo-sm">
                    <img src={logosmlight} alt="" height="35" />
                  </span>
                  <span className="logo-lg">
              ...
              >
                ...
                {/* {!this.state.isOpen ? <i className="ri-menu-3-line align-middle" onClick={this.changeIcon}></i> : <i className="ri-menu-2-line align-middle" onClick={this.changeIcon}></i>} */}
              </Button>
                    ...
                    <FormGroup className="m-0">
                      <InputGroup>
                        <Input
                          type="text"
                          className="form-control"
                          placeholder={this.props.t("Search Products/Items")}
                        />
                        <InputGroupAddon addonType="append">
                          <Button color="#7062e0" type="submit">
                            <i className="ri-search-line"></i>
                          </Button>
                        </InputGroupAddon>
                      </InputGroup>
